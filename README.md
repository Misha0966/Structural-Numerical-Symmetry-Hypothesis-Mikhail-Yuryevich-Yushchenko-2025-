...
В некоторых случаях так же могут совпадать и начальные и конечные цифры, при этом иметь разные разрядности для этих чисел.
...
В некоторых случаях так же могут совпадать и начальные и конечные цифры, при этом иметь разные разрядности.
