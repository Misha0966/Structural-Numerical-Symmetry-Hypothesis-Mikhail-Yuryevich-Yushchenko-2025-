...
В большинстве случаев совпадают как начальные так конечные цифры, при этом имеют разные разрядности для этих чисел.

В некоторых случаях наблюдается частичная симметрия: совпадают начальные или конечные цифры PQ и N * k
