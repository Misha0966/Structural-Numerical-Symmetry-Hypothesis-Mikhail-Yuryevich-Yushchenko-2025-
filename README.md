...
Совпадают как начальные так конечные цифры, при этом  имеют разные разрядности для этих чисел.

Наблюдается частичная симметрия: совпадают начальные или конечные цифры PQ и N * k 
...
Может наблюдается частичная симметрия: совпадает начало или конец.
