...
### Название статьи: Гипотеза структурной числовой симметрии: исследование свойств целых чисел при симметричном разбиении и умножении на части.
...
В рамках десятичной системы счислений, для любого целого числа N≥10, если его разделить на m≥2 натуральных частей, максимально близких по длине, чтобы длины всех частей отличались не более чем на единицу, при этом m∈N но не больше длинны числа N, умножить каждую часть на одно и то же натуральное число k, а затем объединить результаты как десятичное число PQ, то:
