...
В большинстве случаев наблюдается частичная симметрия: совпадают начальные или конечные фрагменты или/и цифры PQ и N * k

Совпадение конца гарантировано: последние цифры или/и фрагменты PQ совпадают с последними цифрами N * k
...
Часто наблюдается частичная симметрия: совпадают начальные или конечные фрагменты PQ и N * k

Совпадение конца гарантировано: последние цифры PQ совпадают с последними цифрами N * k

В большинстве случаев: последние фрагменты PQ и N * k также совпадают, в зависимости от множителя k
