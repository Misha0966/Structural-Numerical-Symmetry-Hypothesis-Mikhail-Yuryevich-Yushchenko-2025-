...
Для любого целого числа N ≥ 10, имеющего d десятичных разрядов, и множителя k, если разбить N на m равных частей (или максимально близких к равным), умножить каждую часть на k, а затем объединить результаты как десятичное число PQ, то: 
