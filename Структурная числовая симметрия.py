...
Original file is located at
    https://colab.research.google.com/drive/1CH8AIdYtHMSN9X2p2bK9tB2jZf_XNJ96
"""
...
results4_df = DataFrame(            # Создаём DataFrame для хранения результатов
...
CSV.write("results4.csv", results4_df) # Записываем DataFrame в файл 'results4.csv'
...
println("\n📄 Результаты сохранены в 'results4.csv'") # Сообщаем пользователю о завершении и месте сохранения файла
return results4_df # Возвращаем таблицу с результатами
end
